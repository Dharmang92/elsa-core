...
export class WorkflowDefinitionsPlugin implements Plugin {
  ...
  public showWorkflowDefinitionEditor = (workflowDefinition: WorkflowDefinition) => {
    toolbarComponentStore.components = [
      () => (
    ...
    studioComponentStore.activeComponentFactory = () => (
      <elsa-workflow-definition-editor workflowDefinition={workflowDefinition} onWorkflowUpdated={this.onWorkflowUpdated} ref={el => (this.workflowDefinitionEditorElement = el)} />
    );
  };
  ...
  public onWorkflowUpdated = async (e: CustomEvent<WorkflowDefinitionUpdatedArgs>) => {
    ...
    await this.saveWorkflowDefinition(updatedWorkflowDefinition, false).catch(() => {
  ...
  private onUnPublishClicked = async (e: CustomEvent) => {
    ...
    await this.workflowDefinitionManager
      .retractWorkflow(definition)
      .then(async () => {
